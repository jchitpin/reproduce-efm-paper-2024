...
# (1) Loads the SBML file for the iAB_RBC_283 SBML file.
# (2) Exports the stoichiometry matrix, metabolite names, and reaction names.
# (3) Export the metabolite formulas to manually check the correct SMILES in
#     the following script 01-confirm-hmr-smiles.jl
# ------------------------------------------------------------------------------
