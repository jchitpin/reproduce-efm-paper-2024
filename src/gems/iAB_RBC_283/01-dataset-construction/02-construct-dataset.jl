...
# (1) Load original iAB_RBC_283 dataset. Stoichiometry matrix and
...
@info("Dropped rows pseudomets: $(length(i4.dropped_rows_pseudometabolites))") #  68
@info("Dropped cols pseudomets: $(length(i4.dropped_cols_pseudometabolites))") # 142
@info("Dropped cols rxnmapper:  $(length(i4.dropped_cols_rxnmapper_limit))")   #   1
