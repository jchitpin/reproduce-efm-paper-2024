...
# 2. Parition nodes by "cat".
# 3. Set node colourscheme: #EA7904 and #7F7F7F.
# 4. Set node size proportional to degree: minimum of 10 and maximum of 30.
# 5. Set edge colourscheme: #EA7904.
# 5. Yifan-Hu proportional network layout with default parameters.
