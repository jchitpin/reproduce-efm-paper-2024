...
\begin{axis}[%
    ...
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{1}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{2}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{3}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{4}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{5}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{6}] {../../cumulative-mass-flow/subpanels/cumulative-source-met-14.dat};

    % Manually added
    \addplot[black, dashed, domain = -50:950,samples = 2] {0.99};
    \node[align=center,font=\small] at (rel axis cs:0.60,0.30) {Glutamine\\[0.25cm]\includegraphics[width=3.0cm]{../../source-metabolite-structures/glutamine.pdf}};
