...
dir_output <- "figures/hepg2-weights/subpanels-c-f/glutamine/carbon-1/02-R-output-figures/sankey.pdf"
...
# TITLE
title1 <- "Top 5 ranked AEFMs of glutamine carbon 1"
...
sankey(#
    ...
    title       = title1,
    grill       = TRUE, #FALSE, # TRUE for debugging
    copyright   = ""
)
dev.off()
