...
dir_output <- "figures/hepg2-weights/subpanels-c-f/glutamine/carbon-5/02-R-output-figures/sankey.pdf"
...
nodes5[2, ]$label_pos <- "below"
nodes5[3, ]$x <- "ID214+4.0"       # ID215. Glutamate[m]
nodes5[3, ]$y <- "ID214+0.5"
nodes5[3, ]$label_pos <- "above"
nodes5[1, ]$x <- "ID125+5.0"       # ID124. AKG[c]
nodes5[1, ]$y <- "ID214"
nodes5[1, ]$label_pos <- "below"

nodes5[nrow(nodes5) + 1,] = c(".R1.Glut.AKG", "", "none", "ID215+3.0", "ID215-2", "down")
nodes5[nrow(nodes5) + 1,] = c(".R2.Glut.AKG", "", "none", "ID215", "ID215-4.0", "left")
nodes5[nrow(nodes5) + 1,] = c(".R3.Glut.AKG", "", "none", "ID125-3.0", "ID125-2", "up")

flows5[nrow(flows5) + 1,] = list("ID215", "R1.Glut.AKG", "EFM 1", 30.121558)
flows5[nrow(flows5) + 1,] = list("ID215", "R1.Glut.AKG", "EFM 2", 18.480782)
flows5[nrow(flows5) + 1,] = list("ID215", "R1.Glut.AKG", "EFM 3", 10.393935)
flows5[nrow(flows5) + 1,] = list("ID215", "R1.Glut.AKG", "EFM 5", 6.957879)
flows5[nrow(flows5) + 1,] = list("R1.Glut.AKG", "R2.Glut.AKG", "EFM 1", 30.121558)
flows5[nrow(flows5) + 1,] = list("R1.Glut.AKG", "R2.Glut.AKG", "EFM 2", 18.480782)
flows5[nrow(flows5) + 1,] = list("R1.Glut.AKG", "R2.Glut.AKG", "EFM 3", 10.393935)
flows5[nrow(flows5) + 1,] = list("R1.Glut.AKG", "R2.Glut.AKG", "EFM 5", 6.957879)
flows5[nrow(flows5) + 1,] = list("R2.Glut.AKG", "R3.Glut.AKG", "EFM 1", 30.121558)
flows5[nrow(flows5) + 1,] = list("R2.Glut.AKG", "R3.Glut.AKG", "EFM 2", 18.480782)
flows5[nrow(flows5) + 1,] = list("R2.Glut.AKG", "R3.Glut.AKG", "EFM 3", 10.393935)
flows5[nrow(flows5) + 1,] = list("R2.Glut.AKG", "R3.Glut.AKG", "EFM 5", 6.957879)
flows5[nrow(flows5) + 1,] = list("R3.Glut.AKG", "ID125", "EFM 1", 30.121558)
flows5[nrow(flows5) + 1,] = list("R3.Glut.AKG", "ID125", "EFM 2", 18.480782)
flows5[nrow(flows5) + 1,] = list("R3.Glut.AKG", "ID125", "EFM 3", 10.393935)
flows5[nrow(flows5) + 1,] = list("R3.Glut.AKG", "ID125", "EFM 5", 6.957879)
...
# TITLE
title5 <- "Top 5 ranked AEFMs of glutamine carbon 5"
