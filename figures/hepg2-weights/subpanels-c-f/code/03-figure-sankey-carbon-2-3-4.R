...
dir_output <- "figures/hepg2-weights/subpanels-c-f/glutamine/carbon-2-3-4/02-R-output-figures/sankey.pdf"
...
nodes2[2, ]$x <- "ID281-2.0"    # ID282. Malate[m]
...
nodes2[nrow(nodes2) + 1,] = c(".R2.MAL.MAL", "", "none", "ID281", "ID281-8", "left")
nodes2[nrow(nodes2) + 1,] = c(".R3.MAL.MAL", "", "none", "ID282-2.5", "ID282-1.5", "up")

# Right malate-OAA loop
nodes2[nrow(nodes2) + 1,] = c(".R1.MAL.OAA", "", "none", "ID282+1.5", "ID282-1.5", "down")
...
# TITLE
title1 <- "Top 5 ranked AEFMs of glutamine carbon 2, 3, 4"
