...
\begin{document}
    ...
    \begin{tikzpicture}
        \node[start] () {\includegraphics[]{../03-remove-borders/remove-borders.pdf}};
        \node[font=\normalfontsize,xshift=-3.2cm,yshift=1.6cm] () {akg[m]};
        \node[font=\normalfontsize,xshift=-4.5cm,yshift=3.5cm] () {gln[s]};
        \node[font=\normalfontsize,xshift=+0.1cm,yshift=3.5cm] () {gln[c]};
        \node[font=\normalfontsize,xshift=+4.8cm,yshift=3.5cm] () {Sink};
        \node[font=\normalfontsize,xshift=+3.4cm,yshift=1.6cm] () {co\textsubscript{2}[s]};
        \node[font=\normalfontsize,xshift=+2.0cm,yshift=1.6cm] () {co\textsubscript{2}[c]};
        \node[font=\normalfontsize,xshift=-0.8cm,yshift=1.6cm] () {co\textsubscript{2}[m]};
        \node[font=\normalfontsize,xshift=-0.8cm,yshift=-1.5cm] () {akg[c]};
        \node[font=\normalfontsize,xshift=+0.7cm,yshift=-1.5cm] () {glu[c]};
        \node[font=\normalfontsize,xshift=+2.5cm,yshift=-1.5cm] () {glu[m]};
        \node[font=\normalfontsize,xshift=+1.4cm,yshift=+0.6cm] () {gln[m]};
        ...
        \node[font=\normalfontsize,xshift=2.5cm,yshift=-4.2cm] () {\includegraphics[width=4cm]{../../../../../source-metabolite-structures/glutamine-carbon-5.pdf}};
    \end{tikzpicture}
