...
\begin{tikzpicture}[%
    ...
    \node[font=\bf\Huge,above=3.5cm of glutamineS] (source) {Source};
    ...
    \draw[dash pattern={on 15.7pt off 10pt},postaction={decorate},line width=2pt] (isocitrateC)  to [bend left=0] node [] {} (co2C);
