...
\begin{tikzpicture}[%
    ...
    \node[node2,fill=mito] at (malateM |- co2M) (prolineM) {};
    \node[node2,fill=cyto] at (prolineM |- hco3C) (prolineC) {};
    \node[node2,fill=cyto] at (succoaM |- co2M) (gshC) {};
    \node[node2,fill=cyto] at (gshC |- hco3C) (ssgC) {};
    ...
    \draw[postaction={decorate},line width=2pt,rounded corners=5mm,cgrey] (hco3S) -| ([xshift=-24pt]sink.north);
    \draw[postaction={decorate},line width=2pt,rounded corners=5mm,cgrey] (co2C.south) |- (hco3C);
    \draw[postaction={decorate},line width=2pt,cgrey] (hco3C)        to [bend right=0] node [] {} (hco3S);
    \draw[postaction={decorate},line width=2pt,rounded corners=5mm,cgrey] ([xshift=+4pt,yshift=1.5pt]alanineM.south) |- (alanineC);
    \draw[postaction={decorate},line width=2pt,cgrey] (glutamateM)   to [bend left=12] node [] {} (glutamateC);
    \draw[postaction={decorate},line width=2pt,cgrey] (glutamateM)   to [bend right=0] node [] {} (alanineM);
    \draw[postaction={decorate},line width=2pt,cgrey] (alanineM)     to [bend right=0] node [] {} (pyruvateM);
    \draw[postaction={decorate},line width=2pt,cgrey] (pyruvateM)    to [bend right=0] node [] {} (co2M);
    \draw[postaction={decorate},line width=2pt,cgrey] (alanineC)     to [bend right=0] node [] {} (alanineS);
    \draw[postaction={decorate},line width=2pt,rounded corners=5mm,cgrey] (alanineS.east) -| ([xshift=-8pt]sink.north);
    \draw[postaction={decorate},line width=2pt,cgrey] (prolineC)     to [bend right=45] node [] {} (prolineM);
    \draw[postaction={decorate},line width=2pt,cgrey] (prolineM)     to [bend right=45] node [] {} (prolineC);
    \draw[postaction={decorate},line width=2pt,cgrey] (gshC)         to [bend right=45] node [] {} (ssgC);
    \draw[postaction={decorate},line width=2pt,cgrey] (ssgC)         to [bend right=45] node [] {} (gshC);
