...
\node[above=0.5cm of pgl.corner 2,carbon,fill=black!50!white,draw=black!50!white] (pgl_c6) {};
...
\node[labelFont,black!50!white] () at (pgl.center) {6PG};
...
\draw[chmcArrow,black!50!white] ([yshift=-0.4cm]g6p.south) to node[midway,right,font=\Huge,xshift=5pt] {v\textsubscript{2}} ([yshift=-0.2cm]pgl_box.north);
\draw[chmcArrow,black!50!white] ([xshift=+0.75cm]pgl.east) to node[midway,below,font=\Huge] {v\textsubscript{3}} ([xshift=-0.75cm]Sf6p.west);
...
\draw[reactionArrow,-{Stealth[left]},black!50!white] ([xshift=-0.75cm,yshift=-0.10cm]fdp.west) to node[midway,below,font=\Huge] {v\textsubscript{6}} ([xshift=+0.75cm,yshift=-0.10cm]f6p.east);
