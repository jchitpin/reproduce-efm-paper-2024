...
\node[labelFont,magenta] () at (glucose.center) {Glc};
...
\node[labelFont,magenta] () at (g6p.center) {G6P};
...
\node[labelFont,magenta] () at (f6p.center) {F6P};
...
\node[labelFont,magenta] () at (fdp.center) {FDP};

% Dihydroxyacetone phosphate
\node[carbon, right=5.0cm of fdp.east, yshift=-1.0cm,fill=black] (dhap_1) {};
...
\node[below=0.25cm of dhap_2,labelFont,magenta] () {DHAP};
...
\node[above=0.25cm of g3p_2,labelFont,magenta] () {G3P};
...
% Reaction arrows
\draw[chmcArrow,magenta] ([xshift=-5.0cm]glucose.west) to node[midway,below,font=\Huge] {v\textsubscript{0}} ([xshift=-0.75cm]glucose.west);
\draw[chmcArrow,magenta] ([xshift=+0.75cm]glucose.east) to node[midway,below,font=\Huge] {v\textsubscript{1}} ([xshift=-0.75cm]g6p.west);
\path[-stealth,magenta, line width=6pt] ([xshift=+1.0cm,yshift=1.0cm]glucose.east) edge[bend right=60,looseness=1.25] ([xshift=-1.0cm,yshift=1.0cm]g6p.west);
\node[labelFont,right=0.50cm of glucose.east,yshift=1.4cm,magenta] (atp1) {ATP};
\node[labelFont,left=0.50cm of g6p.west,yshift=1.4cm,magenta] (adp1) {ADP};

\draw[chmcArrow,magenta] ([xshift=-0.1cm,yshift=+0.5cm]atp1.north west) to node[midway,below,labelFont,xshift=0pt,white] {} ([xshift=-0.5cm]atp1.north);
\draw[chmcArrow,magenta] ([xshift=+0.5cm]adp1.north) to node[midway,below,labelFont,xshift=0pt,white] {} ([xshift=+0.1cm,yshift=+0.5cm]adp1.north east);
...
\draw[chmcArrow,magenta] ([xshift=+0.75cm]g6p.east) to node[midway,below,font=\Huge] {v\textsubscript{4}} ([xshift=-0.75cm]f6p.west);

\draw[reactionArrow,-{Stealth[left]},magenta] ([xshift=+0.75cm,yshift=+0.10cm]f6p.east) to node[midway,above,font=\Huge] {v\textsubscript{5}} ([xshift=-0.75cm,yshift=+0.10cm]fdp.west);
...
\draw[line width=6pt,magenta] ([xshift=+0.75cm]fdp.east) to node[midway,below,font=\Huge] {v\textsubscript{7}} ([xshift=+2.5cm]fdp.east);
\draw[chmcArrow,magenta] ([xshift=+2.5cm]fdp.east) to ([xshift=-0.75cm]g3p_1.west);
\draw[chmcArrow,magenta] ([xshift=+2.5cm]fdp.east) to ([xshift=-0.75cm]dhap_1.west);
...
\draw[chmcArrow,magenta] ([xshift=+0.5cm]g3p_p.east) to node[midway,below,font=\Huge] {v\textsubscript{11}} ([xshift=+4.5cm]g3p_p.east);
\draw[chmcArrow,magenta] ([xshift=+0.5cm]dhap_p.east) to node[midway,below,font=\Huge] {v\textsubscript{10}} ([xshift=+4.5cm]dhap_p.east);
