...
\draw[carbonDraw,draw=black!25!white] (fdp.corner 2) to (fdp_c2);
\node[above=0.5cm of fdp.corner 5,circle,carbon,fill=black!25!white,draw=black!25!white] (fdp_c5) {};
\draw[carbonDraw,draw=black!25!white] (fdp.corner 5) to (fdp_c5);
\draw[fill=white,draw=black!25!white] (fdp.corner 2) node[carbon,fill=black!25!white,draw=black!25!white] () {};
\draw[fill=white,draw=black!25!white] (fdp.corner 3) node[carbon,fill=black!25!white,draw=black!25!white] () {};
\draw[fill=white,draw=black!25!white] (fdp.corner 4) node[carbon,fill=black!25!white,draw=black!25!white] () {};
\draw[fill=white,draw=black!25!white] (fdp.corner 5) node[carbon,fill=black!25!white,draw=black!25!white] () {};
\node[above=0.4cm of fdp_c2,font=\Large,black!25!white] (fdp_p1) {P\textsubscript{i}};
\draw[carbonDraw,draw=black!25!white] (fdp_c2) to (fdp_p1);
\node[above=0.4cm of fdp_c5,font=\Large,black!25!white] (fdp_p2) {P\textsubscript{i}};
\draw[carbonDraw,draw=black!25!white] (fdp_c5) to (fdp_p2);
...
\node[carbon, right=0.25cm of dhap_1,fill=black!25!white,draw=black!25!white]  (dhap_2) {};
\node[carbon, right=0.25cm of dhap_2,fill=black!25!white,draw=black!25!white] (dhap_3) {};
\node[right=0.4cm of dhap_3,font=\Large,black!25!white] (dhap_p) {\textcolor{black!25!white}{P\textsubscript{i}}};
\draw[carbonDraw,draw=black!25!white] (dhap_1) to (dhap_2);
\draw[carbonDraw,draw=black!25!white] (dhap_2) to (dhap_3);
\draw[carbonDraw,draw=black!25!white] (dhap_3) to (dhap_p);
...
\node[carbon, right=0.25cm of g3p_1,fill=black!25!white,draw=black!25!white]  (g3p_2) {};
\node[carbon, right=0.25cm of g3p_2,fill=black!25!white,draw=black!25!white] (g3p_3) {};
\node[right=0.4cm of g3p_3,font=\Large,black!25!white] (g3p_p) {\textcolor{black!25!white}{P\textsubscript{i}}};
\draw[carbonDraw,draw=black!25!white] (g3p_1) to (g3p_2);
\draw[carbonDraw,draw=black!25!white] (g3p_2) to (g3p_3);
\draw[carbonDraw,draw=black!25!white] (g3p_1) to (g3p_p);
...
\draw[chmcArrow,black!25!white] ([xshift=-0.1cm,yshift=+0.5cm]atp1.north west) to node[midway,below,labelFont,xshift=0pt,white] {} ([xshift=-0.5cm]atp1.north);
\draw[chmcArrow,black!25!white] ([xshift=+0.5cm]adp1.north) to node[midway,below,labelFont,xshift=0pt,white] {} ([xshift=+0.1cm,yshift=+0.5cm]adp1.north east);
