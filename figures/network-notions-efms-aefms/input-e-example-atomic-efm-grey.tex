...
\node[carbon, right=5.0cm of fdp.east, yshift=+1.0cm,fill=black!25!white,draw=black!25!white] (g3p_1) {};
...
\node[right=0.4cm of g3p_3,font=\Large,black!25!white] (g3p_p) {P\textsubscript{i}};
\draw[carbonDraw,black!25!white] (g3p_1) to (g3p_2);
\draw[carbonDraw,black!25!white] (g3p_2) to (g3p_3);
\draw[carbonDraw,black!25!white] (g3p_1) to (g3p_p);
...
\node[above=0.5cm of pgl.corner 2,carbon,fill=black!25!white,draw=black!25!white] (pgl_c6) {};
\draw[carbonDraw,draw=black!25!white] (pgl.corner 2) to (pgl_c6);
...
\node[labelFont,black!25!white] () at (pgl.center) {6PG};
...
% Reaction arrows
\draw[chmcArrow,cblue] ([xshift=-5.0cm]glucose.west) to node[midway,below,font=\Huge] {v\textsubscript{r}} ([xshift=-0.75cm]glucose.west);
...
\draw[chmcArrow,cblue] ([xshift=+0.75cm]glucose.east) to node[midway,below,font=\Huge] {v\textsubscript{1}} ([xshift=-0.75cm]g6p.west);
...
\draw[chmcArrow,black!25!white] ([yshift=-0.4cm]g6p.south) to node[midway,right,font=\Huge,xshift=5pt] {v\textsubscript{2}} ([yshift=-0.2cm]pgl_box.north);
\draw[chmcArrow,black!25!white] ([xshift=+0.75cm]pgl.east) to node[midway,below,font=\Huge] {v\textsubscript{3}} ([xshift=-0.75cm]Sf6p.west);

\draw[chmcArrow,cblue] ([xshift=+0.75cm]g6p.east) to node[midway,below,font=\Huge] {v\textsubscript{4}} ([xshift=-0.75cm]f6p.west);
...
\draw[reactionArrow,-{Stealth[left]},cblue] ([xshift=+0.75cm,yshift=+0.10cm]f6p.east) to node[midway,above,font=\Huge] {v\textsubscript{5}} ([xshift=-0.75cm,yshift=+0.10cm]fdp.west);
\draw[reactionArrow,-{Stealth[left]},black!25!white] ([xshift=-0.75cm,yshift=-0.10cm]fdp.west) to node[midway,below,font=\Huge] {v\textsubscript{6}} ([xshift=+0.75cm,yshift=-0.10cm]f6p.east);
...
\draw[chmcArrow,black!25!white] ([xshift=+2.5cm]fdp.east) to ([xshift=-0.75cm]g3p_1.west);
\draw[chmcArrow,cblue] ([xshift=+2.5cm]fdp.east) to ([xshift=-0.75cm]dhap_1.west);

\draw[reactionArrow,-{Stealth[left]},black!25!white] ([xshift=+0.10cm]g3p_2.south) to node[midway,right,font=\Huge,xshift=5pt] {v\textsubscript{9}} ([xshift=+0.10cm]dhap_2.north);
\draw[reactionArrow,-{Stealth[left]},black!25!white] ([xshift=-0.10cm]dhap_2.north) to node[midway,left,font=\Huge,xshift=-5pt] {v\textsubscript{8}} ([xshift=-0.10cm]g3p_2.south);

\draw[chmcArrow,black!25!white] ([xshift=+0.5cm]g3p_p.east) to node[midway,below,font=\Huge] {v\textsubscript{11}} ([xshift=+4.5cm]g3p_p.east);
\draw[chmcArrow,cblue] ([xshift=+0.5cm]dhap_p.east) to node[midway,below,font=\Huge] {v\textsubscript{10}} ([xshift=+4.5cm]dhap_p.east);
