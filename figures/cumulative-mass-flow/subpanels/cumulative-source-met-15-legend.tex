...
\begin{axis}[%
    ...
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{1}] {cumulative-source-met-15.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{2}] {cumulative-source-met-15.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{3}] {cumulative-source-met-15.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{4}] {cumulative-source-met-15.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{5}] {cumulative-source-met-15.dat};
    \addplot[%
        scatter,
        mark=*, draw=black, line width=0.5pt,
        scatter src=explicit symbolic,
        ...
        each nth point=1,filter discard warning=false, unbounded coords=discard
    ] table [x=x, y=yc, meta=atom,discard if not={atom}{6}] {cumulative-source-met-15.dat};

    % Manually added
    \addplot[black, dashed, domain = -50:700,samples = 2] {0.99};
    \node at (rel axis cs:0.60,0.20) {\includegraphics[]{../../source-metabolite-structures/glycine.pdf}};
