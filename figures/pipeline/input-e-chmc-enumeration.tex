...
\draw[drawCarbon,draw opacity=0.25] (dhap_efms_1) to (dhap_efms_2);
\draw[drawCarbon,draw opacity=0.25] (dhap_efms_2) to (dhap_efms_3);
...
\node[fit=(g3p_efms_1) (g3p_efms_2) (g3p_efms_3), draw=none,label={below:{\LARGE G3P}}] (g3p_efms_box) {};/home/jchitpin/Documents/PhD/Projects/reproduce-efm-paper-2024/figures/figure-pipeline-v01/pipeline-v01.pdf

% Transition arrows
\draw[draw=none] (glucose_efms_c6) to[out=225,in=135] node[midway,left,labelFont] {$p_1$} (g6p_efms_c6);
...
\draw[chmcArrow,draw=none] (fdp_efms_c2) to[out=45,in=-45,looseness=1] node[midway,below right,yshift=-0.3cm,labelFont] {$p_6$} (f6p_efms_c2);
...
%\node[above=0.1cm of box_efms.north west, anchor=south west] () {\huge Atomic EFMs \phantom{p}};
