...
\draw[carbonDraw,draw opacity=0.25] (dhap_chmc_1) to (dhap_chmc_2);
\draw[carbonDraw,draw opacity=0.25] (dhap_chmc_2) to (dhap_chmc_3);
...
\node[fit=(g3p_chmc_1) (g3p_chmc_2) (g3p_chmc_3), draw=none,label={below:{\LARGE G3P}}] (g3p_chmc_box) {};

% Transition arrows
\draw[chmcArrow] (glucose_chmc_c6) to[out=225,in=135] node[midway,left,labelFont] {p\textsubscript{1}} (g6p_chmc_c6);
...
\node[above=0.1cm of box_chmc.north,align=center,text width=10.0cm] () {\huge 3. Atomic flux graph\\\phantom{g}construction\;\;\;\phantom{g}};
