...
\draw[reactionArrow,-{Stealth[left]}] ([xshift=+0.10cm]f6p_box.south) to node[midway,right,labelFont,xshift=+0.1cm] {v\textsubscript{5}} ([xshift=+0.10cm]fdp_box.north);
\draw[reactionArrow,-{Stealth[left]}] ([xshift=-0.10cm]fdp_box.north) to node[midway,left,labelFont,xshift=-0.1cm] {v\textsubscript{6}} ([xshift=-0.10cm]f6p_box.south);

\draw[line width=6pt] (fdp_box) to node[midway,right,labelFont,] {v\textsubscript{7}} ([yshift=-0.5cm]fdp_box.south);
...
\draw[reactionArrow,-{Stealth[left]}] ([yshift=+0.10cm]dhap_box.east) to node[midway,above,labelFont,yshift=+0.1cm] {v\textsubscript{8}} ([yshift=+0.10cm]g3p_box.west);
\draw[reactionArrow,-{Stealth[left]}] ([yshift=-0.10cm]g3p_box.west) to node[midway,below,labelFont,yshift=-0.1cm] {v\textsubscript{9}} ([yshift=-0.10cm]dhap_box.east);
