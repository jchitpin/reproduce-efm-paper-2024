...
nitrogen remodelling and, on the HepG2 network, predict glutamine
metabolism through the recently discovered non-canonical TCA cycle. We
anticipate our method will be useful for quantifying cellular metabolism
as high-throughput fluxomic analyses become increasingly common.
...
counterpart which may involve multiple inputs and outputs to balance
...
metabolites converged on common internal metabolites. The weights of AEFMs
sharing metabolite subsequences will likewise be related through their
...
and flux decomposition problem, we expect rapid computational interest in
