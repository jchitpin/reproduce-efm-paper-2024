...
Rscript $BASE_PATH/$DIR/subpanels-c-f/code/03-figure-sankey-carbon-1.R
Rscript $BASE_PATH/$DIR/subpanels-c-f/code/03-figure-sankey-carbon-1-unlabelled.R
Rscript $BASE_PATH/$DIR/subpanels-c-f/code/04-figure-sankey-carbon-2-3-4.R
Rscript $BASE_PATH/$DIR/subpanels-c-f/code/04-figure-sankey-carbon-2-3-4-unlabelled.R
...
cd $BASE_PATH
cd $DIR/subpanels-c-f/glutamine/carbon-1/03-remove-borders
pdflatex -interaction="batchmode" remove-borders.tex
rm remove-borders.aux remove-borders.log

cd $BASE_PATH
cd $DIR/subpanels-c-f/glutamine/carbon-1/04-add-labels
pdflatex -interaction="batchmode" add-labels.tex
rm add-labels.aux add-labels.log

cd $BASE_PATH
cd $DIR/subpanels-c-f/glutamine/carbon-2-3-4/03-remove-borders
pdflatex -interaction="batchmode" remove-borders.tex
rm remove-borders.aux remove-borders.log

cd $BASE_PATH
cd $DIR/subpanels-c-f/glutamine/carbon-2-3-4/04-add-labels
pdflatex -interaction="batchmode" add-labels.tex
rm add-labels.aux add-labels.log
...
pdflatex -interaction="batchmode" network-v3.tex
rm network-v3.aux network-v3.log
# ------------------------------------------------------------------------------
