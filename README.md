...
* The HDF5-compressed data under data/gems/GEM_NAME/atomic-efms-[carbon/nitrogen] is not exported due to file size constraints. However, these files will be regenerated by running the source scripts in the pipeline.
